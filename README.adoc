...
----
Name: NiFi Registry
URL:  http://ec2-3-250-186-34.eu-west-1.compute.amazonaws.com:18080
----
+
...
[source]
----
URL: http://ec2-3-250-186-34.eu-west-1.compute.amazonaws.com:7788/api/v1
----
+
...
[source]
----
Kafka Brokers:                         ec2-3-250-186-34.eu-west-1.compute.amazonaws.com:9092
Topic Name:                            iot
...
[source]
----
URL:           http://cdsw.3.250.186.34.nip.io/api/altus-ds-1/models/call-model
Record Reader: JsonTreeReader
...
[source]
----
Kudu Masters:     ec2-3-250-186-34.eu-west-1.compute.amazonaws.com:7051
...
. Go back to the NiFi Web UI, right-click on an empty area of the *Process Sensor Data* canvas, and click on *configure*.

. Then Click Create Parameter Context, name it *iot*.   You will assign this to your process group.

image::images/createparametercontext.png[width=800]

image::images/parameters.png[width=800]	
...
----
+
image::images/updateParameterContext.png[width=800]	

image::images/addparameter.png[width=800]	
